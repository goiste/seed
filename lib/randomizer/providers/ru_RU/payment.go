...
// PaymentRu Возвращает структуру для генерации случайного банка
//
//goland:noinspection GoExportedFuncWithUnexportedType
func (rf *RusFaker) PaymentRu() *payment {
	return &payment{f: rf.Faker}
}

// Bank Возвращает случайное наименование банка
func (p *payment) Bank() string {
	return p.String()
}

// String Возвращает случайное наименование банка
func (p *payment) String() string {
	return p.f.RandomStringElement(banks)
}
